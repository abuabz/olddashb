...
const rows = [
    createData('Kerala', 'KL', 1324171354, 3287263),
    createData('Tamilnadu', 'TN', 1403500365, 9596961),
    createData('Karnataka', 'KA', 60483973, 301340),
    createData('Delhi', 'DL', 327167434, 9833520),
    createData('Goa', 'GA', 37602103, 9984670),
    createData('Sikkim', 'SK', 25475400, 7692024),
    createData('Maharashtra', 'MH', 83019200, 357578),
];

export default function IndiaTable() {
